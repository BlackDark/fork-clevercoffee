...
export const parameterGroups: ParameterGroup[] = [
	...
	},
	{
		...
		parameters: ['pid.bd.enabled', 'brew.pid_delay', 'pid.bd.kp', 'pid.bd.tn', 'pid.bd.tv']
	},
	{
		key: 'brewControl',
		label: 'Brew Control',
	...
	},
	{
		key: 'maintenance',
		label: 'Maintenance',
		parameters: ['backflush.cycles', 'backflush.fill_time', 'backflush.flush_time']
	},
	{
		key: 'powerSettings',
	...
	},
	{
		...
		parameters: ['system.auth.enabled', 'system.auth.username', 'system.auth.password']
	},
	{
		key: 'runtimeControls',
		label: 'Runtime Controls',
		parameters: ['STEAM_MODE', 'BACKFLUSH_ON', 'TARE_ON', 'CALIBRATION_ON', 'VERSION']
	},
	{
		key: 'oledDisplay',
		label: 'OLED Display',
		parameters: ['hardware.oled.enabled', 'hardware.oled.type', 'hardware.oled.address']
	},
	{
		key: 'relays',
		label: 'Relays',
	...
	},
	{
		key: 'ledsStatus',
		label: 'Status LEDs',
		parameters: ['hardware.leds.status.enabled', 'hardware.leds.status.inverted']
	},
	{
		key: 'ledsBrew',
		label: 'Brew LEDs',
	...
	},
	{
		...
		parameters: ['hardware.sensors.watertank.enabled', 'hardware.sensors.watertank.mode']
	},
	{
		key: 'sensorScale',
		label: 'Scale Sensors',
