export const parameterHelpTexts: Record<string, string> = {
	...
	'pid.steam.kp': 'Proportional gain for the steaming mode (I or D are not used)',
	'brew.setpoint': 'The temperature that the PID will attempt to reach and hold',
	'brew.temp_offset':
	...
	'display.language': 'Set the language for the OLED display, changes requre a reboot',
	'display.fullscreen_brew_timer': 'Enable fullscreen overlay during brew',
	'display.fullscreen_manual_flush_timer': 'Enable fullscreen overlay during manual flush',
	'display.fullscreen_hot_water_timer': 'Enable fullscreen overlay during hot water mode',
	'display.post_brew_timer_duration': 'time in s that brew timer will be shown after brew finished',
	'display.heating_logo': 'full screen logo will be shown if temperature is 5°C below setpoint',
	...
	'mqtt.broker': 'IP addresss or hostname of your MQTT broker, changes require a restart',
	...
	'mqtt.hassio.enabled': 'Enables Home Assistant integration, requires a restart',
	...
	'system.ota_password': 'Password for over-the-air updates, changes require a restart',
	...
	'system.auth.username': 'Username for accessing the website and authenticating web requests.',
	'system.auth.password': 'Password for accessing the website and authenticating web requests.',
	...
	'system.showdisplay.enabled': 'Enable or disable showing sendBuffer loops in debug logs',
	...
	'hardware.relays.heater.trigger_type': 'Relay trigger type for heater control',
	...
	'hardware.leds.status.inverted': 'Invert the status LED logic (for common anode LEDs)',
	'hardware.leds.brew.enabled': 'Enable brew indicator LED',
	'hardware.leds.brew.inverted': 'Invert the brew LED logic (for common anode LEDs)',
	'hardware.leds.steam.enabled': 'Enable steam indicator LED',
	'hardware.leds.steam.inverted': 'Invert the steam LED logic (for common anode LEDs)',
	'hardware.sensors.temperature.type': 'Type of temperature sensor connected',
	'hardware.sensors.pressure.enabled': 'Enable pressure sensor for monitoring brew pressure',
	'hardware.sensors.watertank.enabled': 'Enable water tank level sensor',
	'hardware.sensors.watertank.mode': 'Electrical configuration of water tank sensor',
	'hardware.sensors.scale.enabled': 'Enable integrated scale for weight-based brewing',
