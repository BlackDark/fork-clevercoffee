...
public:
     ...
     */
    void displayMessage(const String& text1, const String& text2 = "", 
     ...
     */
    bool isBufferReady() const { return bufferReady_; }

    /**
     * @brief Set buffer ready state
     * @param ready Buffer ready state
     */
    void setBufferReady(bool ready) { bufferReady_ = ready; }
     ...
     */
    void setUpdateRunning(bool running) { updateRunning_ = running; }
