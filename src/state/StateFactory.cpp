...
const char* getStateName(MachineStateId id) {
    switch (id) {
        case MachineStateId::BACKFLUSH_IDLE: return "Backflush Idle";
        case MachineStateId::BACKFLUSH_FILLING: return "Backflush Filling";
        case MachineStateId::BACKFLUSH_FLUSHING: return "Backflush Flushing";
        case MachineStateId::BACKFLUSH_FINISHED: return "Backflush Finished";
        case MachineStateId::BREW_PREINFUSION: return "Brew Preinfusion";
        case MachineStateId::BREW_PREINFUSION_PAUSE: return "Brew Preinfusion Pause";
        case MachineStateId::BREW_RUNNING: return "Brew Running";
        case MachineStateId::BREW_FINISHED: return "Brew Finished";
        case MachineStateId::EMERGENCY_STOP: return "Emergency Stop";
        case MachineStateId::SENSOR_ERROR: return "Sensor Error";
        case MachineStateId::WATER_TANK_EMPTY: return "Water Tank Empty";
        case MachineStateId::EEPROM_ERROR: return "EEPROM Error";
        case MachineStateId::INIT: return "Init";
        case MachineStateId::PID_NORMAL: return "PID Normal";
        case MachineStateId::PID_DISABLED: return "PID Disabled";
        case MachineStateId::STANDBY: return "Standby";
        case MachineStateId::MANUAL_FLUSH_RUNNING: return "Manual Flush Running";
        case MachineStateId::STEAM_RUNNING: return "Steam Running";
