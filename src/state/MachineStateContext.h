...
public:
     ...
     */
    HardwareManager* getHardwareManager() const { return hardwareManager_; }
    
    /**
     * @brief Get sensor manager
     */
    SensorManager* getSensorManager() const { return sensorManager_; }

    /**
     * @brief Get WiFi manager
     */
    CleverCoffeeWiFiManager* getWiFiManager() const { return wifiManager_; }

    /**
     * @brief Get MQTT manager
     */
    MQTTManager* getMQTTManager() const { return mqttManager_; }
