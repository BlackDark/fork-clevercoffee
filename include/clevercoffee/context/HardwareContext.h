...
public:
     ...
     */
    U8G2* display() const noexcept { return display_; }
    
    /**
     * @brief Register display instance
     * @param display Pointer to display hardware
     */
    void setDisplay(U8G2* display) noexcept { display_ = display; }
     ...
     */
    TempSensor* tempSensor() const noexcept { return tempSensor_; }
    
    /**
     * @brief Register temperature sensor
     * @param sensor Pointer to temperature sensor hardware
     */
    void setTempSensor(TempSensor* sensor) noexcept { tempSensor_ = sensor; }
     ...
     */
    const std::unique_ptr<Scale>& scale() const noexcept { return scale_; }
    
    /**
     * @brief Get scale raw pointer
     * @return Pointer to scale (nullptr if not initialized)
     */
    Scale* scalePtr() const noexcept { return scale_.get(); }
     ...
     */
    bool isBluetoothScale() const noexcept { return isBluetoothScale_; }
