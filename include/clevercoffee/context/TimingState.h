...
class TimingState {
  public:
    ...
    unsigned long previousMillisTemp() const noexcept {
        return previousMillisTemp_;
    }
    void setPreviousMillisTemp(unsigned long time) noexcept {
        previousMillisTemp_ = time;
    }

    unsigned long previousMillisMQTT() const noexcept {
        return previousMillisMQTT_;
    }
    void setPreviousMillisMQTT(unsigned long time) noexcept {
        previousMillisMQTT_ = time;
    }

    unsigned long previousMillisPressure() const noexcept {
        return previousMillisPressure_;
    }
    void setPreviousMillisPressure(unsigned long time) noexcept {
        previousMillisPressure_ = time;
    }

    // Window timing
    unsigned long windowStartTime() const noexcept {
        return windowStartTime_;
    }
    void setWindowStartTime(unsigned long time) noexcept {
        windowStartTime_ = time;
    }
