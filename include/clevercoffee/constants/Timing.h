...
constexpr unsigned long MAX_SENSOR_ERROR_DURATION_MS = 60000;  ///< Maximum sensor error duration before disabling PID (1 minute)
constexpr unsigned long STANDBY_TIMER_RESET_INTERVAL_MS = 30000;  ///< Interval for resetting standby timer in PID state (30 seconds)
