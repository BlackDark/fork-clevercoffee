...
class IOSwitch final : public Switch {
  public:
     ...
     * @param initialState
     */
    IOSwitch(int                  pinNumber,
             GPIOPin::Type        pinType,
             Hardware::SwitchType switchType   = Hardware::SwitchType::MOMENTARY,
             Hardware::SwitchMode mode         = Hardware::SwitchMode::NORMALLY_OPEN,
